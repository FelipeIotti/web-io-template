...
export function Menu() {
  return (
    <div className="z-10 flex h-full w-auto max-w-45 transform flex-col justify-between px-2 py-1 transition-all duration-300 ease-in-out peer-checked:pointer-events-none peer-checked:w-0 peer-checked:-translate-x-full peer-checked:opacity-0">
