...
export function Menu() {
  return (
    <div className="z-10 flex h-full w-70 transform flex-col justify-between px-2 py-1 transition-all duration-500 ease-in-out peer-checked:invisible peer-checked:w-0 peer-checked:-translate-x-full peer-checked:opacity-0">
